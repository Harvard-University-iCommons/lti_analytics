"""
Django settings for lti_analytics project.
...
ROOT_URLCONF = 'lti_analytics.urls'
...
WSGI_APPLICATION = 'lti_analytics.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': SECURE_SETTINGS.get('db_default_name', 'lti_analytics'),
...
CACHES = {
    'default': {
        ...
        'KEY_PREFIX': 'lti_analytics',  # Provide a unique value for shared cache
